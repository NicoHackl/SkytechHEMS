...
| Entität | Werte/Einheit | Pflicht | Verhalten bei fehlendem State | Funktion | Kommentare durch Admin
|---|---|---:|---|---|---|
...
| `input_number.ems_ac_speicher_entlade_abschlag_w` | W | nur mit `battery` | `0` | Systemweiter Restbezug; wird einmal vom gesamten Entladeziel abgezogen, nicht je Speicher | -> Brauch ich genauere erklärung, in welchen Situationen, für welche Geräte etc. das gilt bzw. berücksichtigt wird
