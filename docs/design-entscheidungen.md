...
| D-044 | 21.08.2026 | AC-Speicher entladen nach einer separaten signierten Hausleistungsbilanz (`battery_residual_power_entity`), die Netz- und E3DC-Batterieleistung zusammenführt; der Überschuss-Sensor bleibt für PV-Laden und Verbraucher | Aktiv | Der konservative Überschuss-Sensor würde an der Nulleinspeisung um bis zu `700 W` vorbeiregeln. Ein einziger zusätzlicher Bilanzsensor bildet die Unterdeckung ab, ohne einen zweiten Roh-Netzschutz einzuführen. Ausführlich: [adr/D-044-hausleistungsbilanz-ac-speicher.md](adr/D-044-hausleistungsbilanz-ac-speicher.md). |
